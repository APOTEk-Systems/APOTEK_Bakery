  ...
  return (
    <Layout>
      <div className="p-6">
        ...
        <Tabs defaultValue="vat-tax" className="w-full">
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="vat-tax">VAT & Tax</TabsTrigger>
            <TabsTrigger value="adjustment-reasons">Adjustment Reasons</TabsTrigger>
          ...
          <TabsContent value="adjustment-reasons" className="mt-6">
